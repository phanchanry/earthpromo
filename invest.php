...
<body style="background: url(img/tiny_grid.png);">
 ...
 <div class="main_content">
	<div class="breadcrumbs margin-bottom-40">
	    <div class="container">
	        <h1 class="pull-left">Investment opportunities</h1>
	...
	<div class="container">
		...
		<div class="alert alert-danger fade in col-md-9">
           ...
           There is no result!!
            <?php } else {?> 
            <strong>Sorry!</strong> There is NOT any video related to Investment opportunities category right now.
            <?php }?> 
        </div>
        <?php } else{?>
