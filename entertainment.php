...
<body style="background: url(img/tiny_grid.png);">
 ...
 <!--=== Breadcrumbs ===-->
	<div class="breadcrumbs margin-bottom-40">
	    <div class="container">
	        <h1 class="pull-left">Entertainment/Restaurants</h1>
	        <ul class="pull-right breadcrumb">
	            <li><a href="home.php">Home</a></li>
	            <li class="active">Entertainment/Restaurants</li>
	        </ul>
	    </div>
	</div><!--/breadcrumbs-->
	<div class="col-md-12">
	<div class="container">
		...
		<div class="alert alert-danger fade in col-md-9">
           ...
           There is no result!!
            <?php } else {?> 
            <strong>Sorry!</strong> There is NOT any video related to Entertainment/Restaurant category right now.
            <?php }?> 
        </div>
        <?php } else{?>
		<div class="col-md-5 col-md-offset-2 ">
		<?php if ($formSubmit) {?>
			<div class="row margin-bottom-10" id="videoThumbnail">
				<video id="main_video_screen" class="video-js vjs-default-skin" controls preload="none" width="100%" height="264"
			      poster="<?php if($oneVideoDataThumb != "" && $_POST['videoId'] != "") echo $oneVideoDataThumb; else echo 'img/black_thumb.png';?>"  
			      data-setup='{"plugins":{"addThis":{"website_url": "http://www.google.com", "embed": true, "reddit":false,"delicious":false}}}'>
				    <source src="<?php if($oneVideoDataPath != "" && $_POST['videoId'] != "")echo $oneVideoDataPath; else echo ""; ?>" type='video/mp4' />
