...
<div class="main_content">
 <!--=== Breadcrumbs ===-->
	<div class="breadcrumbs margin-bottom-40" id="mainScroll">
	    <div class="container">
	...
	<div class="col-md-12">
		<div class="container">
			...
			<div class="alert alert-danger fade in col-md-9">
	           ...
	           There is no result!!
	            <?php } else {?> 
	            <strong>Sorry!</strong> There is NOT any video related to Business category right now.
	            <?php }?> 
	        </div>
	        <?php } else{?>
